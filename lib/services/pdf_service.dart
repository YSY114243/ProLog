...
/// );
/// await PdfService.instance.downloadPdf(bytes, 'ProLog_Report.pdf');
/// ```
class PdfService {
  PdfService._();
  ...
  Future<Uint8List> generateInternshipReport({
    ...
    final doc = pw.Document(
      ...
      author:  student.name.isNotEmpty ? student.name : 'ProLog User',
      creator: 'ProLog – Professional Log',
    );
    ...
    return pw.Column(
      children: [
        ...
        pw.Row(
          ...
          children: [
            pw.Text(
              'Generated by ProLog  ·  Professional Log for Civil Engineering',
              style: pw.TextStyle(
                font:     pw.Font.helveticaOblique(),
                fontSize: 7.5,
                color:    _C.muted,
